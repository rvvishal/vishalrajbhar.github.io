...
const projects = [
    ...
    overview: "Exxtra is a modern clothing e-commerce website designed to showcase fashion products through a clean, visually engaging, and easy-to-navigate interface.",
    challenge: "The challenge was to create a stylish shopping experience that highlights clothing products while keeping navigation, product discovery, and purchasing simple.",
